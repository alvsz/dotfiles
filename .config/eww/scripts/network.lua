...
local function main()
    ...
    for _, i in ipairs(NetworkManager.AllDevices) do
        ...
        if props.ActiveConnection == NetworkManager.PrimaryConnection and
            ...
            local wireless = getallproperties('org.freedesktop.NetworkManager',
                                              i,
            ...
            for _, j in pairs(wireless.AccessPoints) do
                ...
                if string.len(ap.Ssid) == 0 then
                    ap.Ssid = ap.HwAddress
                end
            ...
            props.expand =
                string.lower(capture("eww get wifi | jq '.expand'")) == "true"
            -- props.expand = false
